...
use crate::{
    ...
    sqlite::{SqliteHistories, SqliteNamespaces, SqliteObjects, SqliteStats},
};
...
fn new_updated_metadata_if_needed(stat: &Option<Stat>, path: &Path) -> Result<Option<FileMetadata>, Box<dyn Error>> {
